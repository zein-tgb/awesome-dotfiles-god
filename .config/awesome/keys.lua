...
--Tenga cuidado: utilizamos códigos clave para que funcione en cualquier diseño de teclado.
--Esto debería asignarse a la fila superior de su teclado, generalmente del 1 al 9.
for i = 1, 9 do
    globalkeys = gears.table.join(globalkeys,
        --Ver etiqueta solamente.
        ...
        --Alternar etiqueta en cliente enfocado.
